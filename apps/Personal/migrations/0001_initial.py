    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fotografia', models.ImageField(null=True, upload_to=b'', blank=True)),
                ('oficina', models.CharField(max_length=150, null=True, blank=True)),
                ('area', models.ForeignKey(related_name='funcionarios', blank=True, to='Personal.Area', null=True)),
                ('cargo', models.ForeignKey(related_name='funcionarios', blank=True, to='Personal.Cargo', null=True)),
